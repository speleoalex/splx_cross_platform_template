...
var splx = new function () {
     ...
     * @param {type} min
     * @param {type} max
     * @returns {Number|splx.splx_utilitysplx.rand.min}
     */
     ...
     * @returns {splx.splx_utilitysplx.print_r.formatArray.str|String|splx.splx_utilitysplx.print_r.output|Boolean}
     */
